...
# if __name __ == '__main__':
    ...
    # # Choose parameters for the elliptic curve
    # curve = (1, 0, 7)
    # a, b, p = curve

    # visualize_curve((0, p - 1), *curve)
    # points = list(generate_point_cloud(a, b, p))
    # P = random.choice(points)
    # Q = random.choice(points)
    # R = point_addition(P, Q, a, b, p)s
    # print(R)
    # visualize_addition(plt, P, Q, a, b, p)
    # plt.show()
    # points = list(generate_point_cloud(a, b, p))
    ...
    # Q = (0.5, f(0.5, a, b)[0])
    # print(P, Q)
    # plot = visualize_addition(ax, P, Q, a, b)
    # plt.show()
    ...
    # P = (1, f(1, a, b)[0])
    # print(P)
    # plot = visualize_multiplication(ax, P, 3, a, b)
    # plt.show()


    # # # test point addition over a field
    # fig, ax = plt.subplots()
    ...
    # Q = (0, 0)
    # print(P, Q)
    # visualize_addition(ax, P, Q, a, b, p)
    # # should be 1,4

    # # show the plot
    # plt.show()

    # # test point multiplication over a field
    # fig, ax = plt.subplots()
    # visualize_curve(ax, (-20, 20), *curve)
    # P = (3, 3)
    # plot = visualize_multiplication(ax, P, 2, a, b, p)
    # plt.show()
    # # should be 1, 4
...
# import random 
# primes = [3, 5, 7, 11, 73, 59]
# curves = [curve1, curve2, curve3, curve4, curve5]
# for curve in curves:
#     for prime in primes:
#         curve_over_field = (*curve, prime)
#         points = list(generate_point_cloud(*curve_over_field))
#         for _ in range(10):
#             P = random.choice(list(points))
#             k = random.randint(1, 100)
#             print(curve_over_field)
#             print(P)
#             print(k)
#             print(point_scalar_multiplication(P, k, *curve_over_field))

# curve = (2, 3, 97)
#     P = (17, 10)
#     P = (17, 87)
#     self.assertEqual(point_addition(P, Q, *curve), (None, None), msg = "Try again!")

# curve = (-6, 9)
# P = (5, f(5, *curve)[0])
# for k in range(1, 15):
#     print(point_scalar_multiplication(P, k, *curve))

# tinycurve = (1, -1, 10177)
# print(generate_point_cloud(*tinycurve))