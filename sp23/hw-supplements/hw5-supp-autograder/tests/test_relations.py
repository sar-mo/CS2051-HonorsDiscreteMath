...
class TestRelations(unittest.TestCase):
    def setUp(self) -> None:
        ...
        relation1 = [(0, 0), (1, 1), (2, 2), (3, 3)]
        relation2 = [(0, 0), (1, 1), (2, 0), (2, 2), (2, 3), (3, 2), (3, 3)]
        relation3 = [(0, 0), (1, 1), (1, 2), (2, 2), (3, 3)]
        relation4 = [(0, 0), (1, 1), (1, 2), (1, 3), (2, 2), (2, 3), (3, 3)]
        relation5 = [(0, 0), (0, 1), (0, 2), (1, 0), (1, 1), (1, 2), (2, 0), (2, 2), (3, 3)]
        relation6 = [(0, 0), (2, 2), (3, 3)]
        relation7 = [(0, 0), (1, 1), (2, 0), (2, 2), (2, 3), (3, 3)]
        relation8 = [(0, 0), (1, 1), (1, 2), (2, 2), (3, 1), (3, 3)]
        relation9 = [(0, 0), (1, 1), (1, 2), (1, 3), (2, 0), (2, 2), (2, 3), (3, 0), (3, 3)]
        ...
        self.relations = [relation1, relation2, relation3, relation4, relation5, relation6, relation7, relation8, relation9, relation10, relation11, relation12, relation13]
        # refactor this later
        self.elements = [{0, 1, 2, 3} for i in range(len(self.relations))]
    ...
    def test_isPartialOrder(self):
        with mock.patch('sys.stdout', new = StringIO()) as std_out:
            ...
            for i in range(len(self.relations)):
                self.assertEqual(isPartialOrder(self.elements[i], self.relations[i]), sol.isPartialOrder(self.elements[i], self.relations[i]), msg='isPartialOrder failed')
    ...
    def test_isEquivalence_Relation(self):
        with mock.patch('sys.stdout', new = StringIO()) as std_out:
            ...
            self.test_allowed_methods()
            for i in range(len(self.relations)):
                self.assertEqual(isEquivalenceRelation(self.elements[i], self.relations[i]), sol.isEquivalenceRelation(self.elements[i], self.relations[i]), msg='isEquivalenceRelation failed')
            self.assertEqual(isPartialOrder({}, {}), True, msg="Failed, look at the *formal* definition of reflexivity, antisymmetry, and transitivity.")
